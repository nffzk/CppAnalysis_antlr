...
public interface ICPP14ParserListener : IParseTreeListener {
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNewExpression_([NotNull] CPP14Parser.NewExpression_Context context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.newExpression_"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNewExpression_([NotNull] CPP14Parser.NewExpression_Context context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNewDeclarator_([NotNull] CPP14Parser.NewDeclarator_Context context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.newDeclarator_"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNewDeclarator_([NotNull] CPP14Parser.NewDeclarator_Context context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterNewInitializer_([NotNull] CPP14Parser.NewInitializer_Context context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.newInitializer_"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitNewInitializer_([NotNull] CPP14Parser.NewInitializer_Context context);
	/// <summary>
	...
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void EnterEmptyDeclaration_([NotNull] CPP14Parser.EmptyDeclaration_Context context);
	/// <summary>
	/// Exit a parse tree produced by <see cref="CPP14Parser.emptyDeclaration_"/>.
	/// </summary>
	/// <param name="context">The parse tree.</param>
	void ExitEmptyDeclaration_([NotNull] CPP14Parser.EmptyDeclaration_Context context);
	/// <summary>
